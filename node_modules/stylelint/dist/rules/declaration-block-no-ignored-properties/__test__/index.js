...
(0, _testUtils.testRule)(_2.default, {
  ...
  reject: [{
    ...
    message: _.messages.rejected("width", "display: inline"),
    line: 1,
    column: 22,
    ...
    message: _.messages.rejected("height", "display: inline"),
    line: 1,
    column: 22,
    description: "display: inline rules out width, height, margin-top and margin-bottom, and float"
  }, {
    code: "a { display: inline; margin: 100px; }",
    message: _.messages.rejected("margin", "display: inline"),
    line: 1,
    column: 22,
    description: "display: inline rules out width, height, margin-top and margin-bottom, and float"
  }, {
    code: "a { display: inline; margin-top: 100px; }",
    message: _.messages.rejected("margin-top", "display: inline"),
    line: 1,
    column: 22,
    description: "display: inline rules out width, height, margin-top and margin-bottom, and float"
  }, {
    code: "a { display: inline; margin-bottom: 100px; }",
    message: _.messages.rejected("margin-bottom", "display: inline"),
    line: 1,
    column: 22,
    description: "display: inline rules out width, height, margin-top and margin-bottom, and float"
  }, {
    code: "a { display: inline; float: left; }",
    message: _.messages.rejected("float", "display: inline"),
    line: 1,
    column: 22,
    description: "display: inline rules out width, height, margin-top and margin-bottom, and float"
  }, {
    code: "a { display: inline-block; float: left; }",
    message: _.messages.rejected("float", "display: inline-block"),
    line: 1,
    column: 28,
    description: "display: inline-block rules out float"
  }, {
    code: "a { display: block; vertical-align: baseline; }",
    message: _.messages.rejected("vertical-align", "display: block"),
    line: 1,
    column: 21,
    description: "display: block rules out baseline"
  }, {
    code: "a { display: table-cell; margin: 10px; }",
    message: _.messages.rejected("margin", "display: table-cell"),
    line: 1,
    column: 26,
    description: "display: table-* rules out margin"
  }, {
    code: "a { display: table-cell; margin-top: 10px; }",
    message: _.messages.rejected("margin-top", "display: table-cell"),
    line: 1,
    column: 26,
    description: "display: table-* rules out margin"
  }, {
    code: "a { display: table-cell; margin-right: 10px; }",
    message: _.messages.rejected("margin-right", "display: table-cell"),
    line: 1,
    column: 26,
    description: "display: table-* rules out margin"
  }, {
    code: "a { display: table-cell; margin-bottom: 10px; }",
    message: _.messages.rejected("margin-bottom", "display: table-cell"),
    line: 1,
    column: 26,
    description: "display: table-* rules out margin"
  }, {
    code: "a { display: table-cell; margin-left: 10px; }",
    message: _.messages.rejected("margin-left", "display: table-cell"),
    line: 1,
    column: 26,
    description: "display: table-* rules out margin"
  }, {
    code: "a { display: table-row; margin: 10px; }",
    message: _.messages.rejected("margin", "display: table-row"),
    line: 1,
    column: 25,
    description: "display: table-* rules out margin"
  }, {
    code: "a { position: static; top: 1px; }",
    message: _.messages.rejected("top", "position: static"),
    line: 1,
    column: 23,
    description: "position: static rules out top, right, bottom, and left"
  }, {
    code: "a { position: static; right: 1px; }",
    message: _.messages.rejected("right", "position: static"),
    line: 1,
    column: 23,
    description: "position: static rules out top, right, bottom, and left"
  }, {
    code: "a { position: static; bottom: 1px; }",
    message: _.messages.rejected("bottom", "position: static"),
    line: 1,
    column: 23,
    description: "position: static rules out top, right, bottom, and left"
  }, {
    code: "a { position: static; left: 1px; }",
    message: _.messages.rejected("left", "position: static"),
    line: 1,
    column: 23,
    description: "position: static rules out top, right, bottom, and left"
  }, {
    code: "a { position: absolute; float: left; }",
    message: _.messages.rejected("float", "position: absolute"),
    line: 1,
    column: 25,
    description: "position: absolute rules out float"
  }, {
    code: "a { position: absolute; clear: left; }",
    message: _.messages.rejected("clear", "position: absolute"),
    line: 1,
    column: 25,
    description: "position: absolute rules out clear"
  }, {
    code: "a { position: fixed; float: left; }",
    message: _.messages.rejected("float", "position: fixed"),
    line: 1,
    column: 22,
    description: "position: absolute rules out float"
  }, {
    code: "a { position: fixed; clear: left; }",
    message: _.messages.rejected("clear", "position: fixed"),
    line: 1,
    column: 22,
    description: "position: absolute rules out float"
  }]
