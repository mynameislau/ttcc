...
(0, _testUtils.testRule)(_2.default, {
  ...
  reject: [{
    code: "a { Display: block; }",
    message: _.messages.expected("Display", "display"),
    line: 1,
    column: 5
  }, {
    code: "a { DisplaY: block; }",
    ...
    message: _.messages.expected("border-Radius", "border-radius"),
    line: 1,
    column: 5
  }, {
    code: "a { border-RADIUS: block; }",
    ...
    code: "a { -WEBKIT-animation-duration: 3s; }",
    message: _.messages.expected("-WEBKIT-animation-duration", "-webkit-animation-duration"),
    line: 1,
    column: 5
  }, {
    code: "a { -webkit-Animation-duration: 3s; }",
    ...
    code: "@media screen and (orientation: landscape) { Width: 500px; }",
    message: _.messages.expected("Width", "width"),
    line: 1,
    column: 46
  }, {
    code: "a { Property: value; }",
    description: "non-standard property",
    message: _.messages.expected("Property", "property"),
    line: 1,
    column: 5
  }]
});
...
(0, _testUtils.testRule)(_2.default, {
  ...
  reject: [{
    code: "&-sidebar { Border: 1px solid; }",
    description: "referencing parent selectors",
    message: _.messages.expected("Border", "border"),
    line: 1,
    column: 13
  }, {
    code: "a { Font: (italic bold 10px/8px) }",
    message: _.messages.expected("Font", "font"),
    line: 1,
    column: 5
  }, {
    code: "a { font: { Size: 30em; } }",
    description: "nested properties",
    message: _.messages.expected("Size", "size"),
    line: 1,
    column: 13
  }, {
    code: "#context a%extreme { Color: red; }",
    description: "extend only selectors",
    message: _.messages.expected("Color", "color"),
    line: 1,
    column: 22
  }, {
    code: ".parent { @at-root { .child1 { Display: block; } } }",
    ...
    code: "@mixin large-text { Font-size: 20px; }",
    description: "inside mixin",
    message: _.messages.expected("Font-size", "font-size"),
    line: 1,
    column: 21
  }, {
    code: "p { @if 1 + 1 == 2 { Border: 1px solid;  } }",
...
(0, _testUtils.testRule)(_2.default, {
  ...
  reject: [{
    ...
    message: _.messages.expected("Font-weight", "font-weight"),
    line: 1,
    column: 19
  }, {
    code: ".mixin(@color: black) { Color: @color; }",
    ...
    code: "a { Box-shadow+: inset 0 0 10px #555; }",
    description: "mergeable property",
    message: _.messages.expected("Box-shadow+", "box-shadow+"),
    line: 1,
    column: 5
  }, {
    code: "a { Transform+_: scale(2); }",
    description: "mergeable property with space",
    message: _.messages.expected("Transform+_", "transform+_"),
    line: 1,
    column: 5
  }, {
