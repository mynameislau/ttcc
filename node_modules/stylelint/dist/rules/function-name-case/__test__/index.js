...
(0, _testUtils.testRule)(_2.default, {
  ...
  reject: [{
    code: "a { margin: Calc(5% - 10em); }",
    message: _.messages.expected("Calc", "calc"),
    line: 1,
    column: 13
  }, {
    code: "a { margin: cAlC(5% - 10em); }",
    ...
    code: "a::before { content: Attr(data-foo\n); }",
    message: _.messages.expected("Attr", "attr"),
    line: 1,
    column: 22
  }, {
    code: "a::before { content: aTtR(data-foo\n); }",
    ...
    code: "a { padding: Some-function(5px); }",
    message: _.messages.expected("Some-function", "some-function"),
    line: 1,
    column: 14
  }, {
    code: "a { padding: some-Function(5px); }",
    ...
    code: "a { background: -WEBKIT-radial-gradient(red, green, blue); }",
    message: _.messages.expected("-WEBKIT-radial-gradient", "-webkit-radial-gradient"),
    line: 1,
    column: 17
  }, {
    code: "@media (max-width: 10px) { a { color: Color(rgb(0, 0, 0) lightness(50%)); } }",
    ...
    code: "@media (max-width: 10px) { a { color: color(Rgb(0, 0, 0) lightness(50%)); } }",
    message: _.messages.expected("Rgb", "rgb"),
    line: 1,
    column: 45
  }, {
    code: "@media (max-width: 10px) { a { color: color(rgb(0, 0, 0) Lightness(50%)); } }",
    message: _.messages.expected("Lightness", "lightness"),
    line: 1,
    column: 58
  }, {
    code: "a { transform: TranslateX(0); }",
    message: _.messages.expected("TranslateX", "translateX"),
    line: 1,
    column: 16
  }, {
    code: "a { transform: tRaNsLaTeX(0); }",
