...
(0, _testUtils.testRule)(_2.default, {
  ...
  reject: [{
    code: "a { display: Block; }",
    message: _.messages.expected("Block", "block"),
    line: 1,
    column: 14
  }, {
    code: "a { display: bLoCk; }",
    ...
    code: "a { display: block !Import; }",
    message: _.messages.expected("!Import", "!import"),
    line: 1,
    column: 20
  }, {
    code: "a { display: block !iMpOrT; }",
    ...
    code: "a { background-position: Top right, 1em 5vh; }",
    message: _.messages.expected("Top", "top"),
    line: 1,
    column: 26
  }, {
    code: "a { background-position: top Right, 1em 5vh; }",
    message: _.messages.expected("Right", "right"),
    line: 1,
    column: 30
  }, {
    code: "a { transition: -Webkit-transform 2s; }",
    message: _.messages.expected("-Webkit-transform", "-webkit-transform"),
    line: 1,
    column: 17
  }, {
    code: "a { transition: -webkit-Transform 2s; }",
    ...
    code: "a { background-image: linear-gradient(To right, white calc(100% - 50em), silver); }",
    message: _.messages.expected("To", "to"),
    line: 1,
    column: 39
  }, {
    code: "a { background-image: linear-gradient(to Right, white calc(100% - 50em), silver); }",
    ...
    code: "a { background-image: linear-gradient(to right, white calc(100% - 50em), Silver); }",
    message: _.messages.expected("Silver", "silver"),
    line: 1,
    column: 74
  }, {
    code: "a { display: Super-block; }",
    description: "work with unknown value keyword",
    message: _.messages.expected("Super-block", "super-block"),
    line: 1,
    column: 14
  }, {
    code: "@media (min-width: 768px) { color: Red; }",
    message: _.messages.expected("Red", "red"),
    line: 1,
    column: 36
  }, {
    code: "@media screen { color: green; @media (min-width: 768px) { color: Red; } }",
    ...
    code: "a { text-rendering: OptimizeSpeed; }",
    message: _.messages.expected("OptimizeSpeed", "optimizeSpeed"),
    line: 1,
    column: 21
  }]
});
...
(0, _testUtils.testRule)(_2.default, {
  ...
  reject: [{
    ...
    message: _.messages.expected("Bold", "bold"),
    line: 1,
    column: 19
  }, {
    code: ".content { .link { display: Block; } }",
    ...
    code: "$map: (Display-first: block, display-second: inline);",
    message: _.messages.expected("Display-first", "display-first"),
    line: 1,
    column: 8
  }, {
    code: "$map: (display-first: Block, display-second: inline);",
    ...
    code: "$map: (display-first: block, display-second: Inline);",
    message: _.messages.expected("Inline", "inline"),
    line: 1,
    column: 46
  }]
});
...
(0, _testUtils.testRule)(_2.default, {
  ...
  reject: [{
    code: ".bordered { border-bottom: Solid 2px black; }",
    description: "inside mixin",
    message: _.messages.expected("Solid", "solid"),
    line: 1,
    column: 28
  }, {
    code: ".bordered { border-bottom: solid 2px Black; }",
    description: "inside mixin",
    message: _.messages.expected("Black", "black"),
    line: 1,
    column: 38
  }, {
    code: "#header { .navigation { display: Block; } }",
...
(0, _testUtils.testRule)(_2.default, {
  ...
  reject: [{
    ...
    code: "a { display: fLeX; }",
    message: _.messages.expected("fLeX", "flex"),
    line: 1,
    column: 14
  }, {
    code: "a { display: FLEX; }",
